...
__all__ = [
    ...
    'ISpNotifySource', 'SPEI_INTERFERENCE', 'SVP_7',
    'SAFT32kHz16BitStereo', 'SPEVENTENUM', 'SSTTTextBuffer',
    'SSFMCreateForWrite', 'SAFT22kHz16BitMono',
    'DISPID_SpeechLexiconWord', 'DISPID_SRGCmdSetRuleState',
    'SPINTERFERENCE', 'DISPID_SOTCEnumerateTokens', 'SPPS_RESERVED3',
    'SAFT8kHz16BitStereo', 'SPEI_TTS_PRIVATE', 'SPPS_RESERVED4',
    'SPFM_NUM_MODES', 'SPEI_RECO_OTHER_CONTEXT',
    'SpeechDisplayAttributes', 'SVSFPurgeBeforeSpeak',
    'DISPID_SRCEAudioLevel', 'SPFM_OPEN_READONLY',
    'DISPID_SPIElements', 'DISPID_SPRules_NewEnum',
    'SpSharedRecognizer', 'STCLocalServer', 'SpeechRunState',
    'SRSEIsSpeaking', 'DISPID_SpeechPhraseReplacement',
    'SDKLCurrentUser', 'ISequentialStream', 'SpUnCompressedLexicon',
    'SP_VISEME_6', 'SAFTCCITT_uLaw_11kHzStereo', 'SRCS_Enabled',
    'DISPID_SRRSetTextFeedback', 'ISpeechMMSysAudio',
    'ISpRecoCategory', 'SVP_14', 'SpeechEmulationCompareFlags',
    'SPDKL_DefaultLocation', 'SVP_1', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpPhoneticAlphabetSelection', 'SpVoice',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPFM_CREATE_ALWAYS', 'SITooQuiet',
    'DISPID_SpeechMMSysAudio', 'DISPID_SVDisplayUI', 'SASPause',
    'ISpeechPhraseAlternates', 'SASClosed', 'DISPID_SpeechFileStream',
    'SAFTADPCM_44kHzStereo', 'SpeechRecognitionType',
    'eLEXTYPE_PRIVATE16', 'SVEViseme', 'DISPID_SDKOpenKey',
    'SRESoundStart', 'SAFT32kHz16BitMono', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SpeechLexiconProns', 'DISPID_SPERetainedSizeBytes',
    'SWTAdded', 'SpeechWordType', 'SECLowConfidence',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPGRAMMARSTATE',
    'DISPID_SRCEventInterests', 'DISPID_SGRsAdd', 'DISPID_SRGId',
    'SPDKL_LocalMachine', 'ISpeechBaseStream', 'SpLexicon',
    'SPRST_ACTIVE_ALWAYS', 'SREAudioLevel',
    'DISPID_SpeechPhraseProperties', 'SAFT11kHz16BitMono',
    'DISPID_SPIProperties', 'SVP_6', 'SPPS_Modifier',
    'SDTDisplayText', 'ISpeechPhraseProperties', 'SP_VISEME_15',
    'DISPID_SVEBookmark', 'DISPID_SGRSTType', 'SVEPhoneme', 'SPSVerb',
    'SpeechTokenValueCLSID', 'DISPID_SMSGetData', 'SPVISEMES',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SRCRetainedAudio',
    'ISpShortcut', 'DISPID_SpeechWaveFormatEx', 'SPSEMANTICFORMAT',
    'SAFTADPCM_22kHzMono', 'SRTExtendableParse',
    'ISpeechPhraseInfoBuilder', 'SDTRule', 'SPCS_DISABLED',
    'SAFT24kHz16BitMono', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SPPsCount', 'SpeechSpecialTransitionType',
    'DISPID_SOTCategory', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SOTCDefault', 'DISPID_SVResume', 'DISPID_SAFGuid',
    'DISPID_SPRsCount', 'SPEI_RECOGNITION', 'SREAllEvents',
    'SpeechPropertyResponseSpeed', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SASFreeBufferSpace', 'DISPID_SGRAddResource', 'SLOStatic',
    'eLEXTYPE_RESERVED10', 'DISPID_SLWs_NewEnum',
    'DISPID_SpeechLexiconWords', 'SPSERIALIZEDRESULT', 'ISpeechAudio',
    'SPEI_SR_RETAINEDAUDIO', 'SPEI_RESERVED6',
    'SREPropertyStringChange', 'SDTProperty', 'DISPID_SPEsItem',
    'SPCT_SUB_DICTATION', '_ISpeechRecoContextEvents',
    'DISPID_SRRTLength', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SGDisplay', 'SPSFunction', 'SpAudioFormat', 'SPLOADOPTIONS',
    'SAFT32kHz8BitStereo', 'ISpObjectTokenCategory', 'SVP_11',
    'SpPhoneConverter', 'SBOPause', 'SPSUnknown', 'DISPID_SRCResume',
    'DISPID_SABufferInfo', 'SPCATEGORYTYPE',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SPIGetText',
    'DISPID_SOTGetDescription', 'SPSHT_NotOverriden',
    'ISpeechWaveFormatEx', 'SAFTADPCM_11kHzMono',
    ...
    'SpeechCategoryRecognizers', 'SDKLCurrentConfig',
    'DISPID_SPEAudioTimeOffset', 'SAFTNonStandardFormat', 'SPPS_Noun',
    'SGLexical', 'SPCS_ENABLED', 'DISPID_SAVolume',
    'DISPID_SRCCreateResultFromMemory', 'SP_VISEME_9',
    'DISPID_SRStatus', 'DISPID_SpeechPhraseProperty', 'SPRS_ACTIVE',
    'SAFTCCITT_uLaw_8kHzStereo', 'eLEXTYPE_LETTERTOSOUND',
    '_ISpeechVoiceEvents', 'SPEI_SR_BOOKMARK', 'SPPHRASE',
    'SPRECOGNIZERSTATUS', 'SFTSREngine', 'DISPID_SVIsUISupported',
    'DISPID_SGRsDynamic', 'eLEXTYPE_PRIVATE14', 'WAVEFORMATEX',
    'SP_VISEME_17', 'SpeechRecoEvents', 'DISPID_SVRate',
    'SPBOOKMARKOPTIONS', 'SpeechTokenKeyUI',
    'DISPID_SRGSetWordSequenceData', 'SPCT_SLEEP',
    'SVESentenceBoundary', 'SWTDeleted', 'DISPID_SRState',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SVGetAudioOutputs',
    'DISPID_SMSSetData', 'DISPID_SPIEngineId',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SLWsItem',
    'DISPID_SRSetPropertyString', 'DISPID_SRCVoice',
    'ISpeechRecoResult', 'eLEXTYPE_PRIVATE10',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SASCurrentSeekPosition',
    'SGRSTTDictation', 'SITooFast', 'SpeechRegistryUserRoot',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRCEPropertyStringChange',
    'SVSFVoiceMask', 'ISpeechRecoResultDispatch',
    'SPTEXTSELECTIONINFO', 'DISPID_SRCEInterference',
    'SAFT48kHz8BitStereo', 'SPWORDPRONOUNCEABLE',
    'ISpeechObjectTokens', 'SPWT_PRONUNCIATION',
    'DISPID_SOTCGetDataKey',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_RESERVED4', 'DISPID_SDKCreateKey',
    'SGLexicalNoSpecialChars', 'SPINTERFERENCE_NOSIGNAL',
    'SPWORDLIST', 'DISPID_SVEventInterests', 'DISPID_SPACommit',
    'SpeechRuleAttributes', 'DISPID_SRRAudio', 'SPEI_RESERVED5',
    'SDTAll', 'SPDATAKEYLOCATION', 'SPCT_COMMAND',
    'DISPID_SVAudioOutput', 'eLEXTYPE_PRIVATE1', 'SPSHORTCUTTYPE',
    'DISPID_SVEAudioLevel', 'ISpeechAudioBufferInfo',
    'eWORDTYPE_DELETED', 'DISPID_SRGSetTextSelection',
    'DISPID_SLWWord', 'SVP_8', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SABufferNotifySize', 'SPGS_DISABLED',
    'DISPID_SRGCmdLoadFromResource', 'IStream', 'SECFEmulateResult',
    'DISPID_SWFEBlockAlign', 'DISPID_SGRId',
    'DISPID_SpeechGrammarRule', 'DISPID_SVWaitUntilDone',
    'SPBO_TIME_UNITS', 'SpeechAudioFormatGUIDWave',
    'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechPhraseInfo', 'SpeechMicTraining',
    'DISPID_SVEVoiceChange', 'SAFT24kHz8BitMono',
    'ISpeechObjectTokenCategory', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SVPriority', 'ISpeechRecognizerStatus',
    'ISpeechPhraseElement', 'SpeechCategoryRecoProfiles',
    'ISpRecoGrammar', 'SpWaveFormatEx', 'DISPID_SPEsCount', 'SVP_18',
    'DISPID_SOTCSetId', 'DISPID_SWFESamplesPerSec', 'ISpRecognizer',
    'SVSFIsXML', 'SpeechTokenContext', 'SPRECOSTATE',
    'SpNotifyTranslator', 'SRAExport', 'SASRun', 'DISPID_SLPPhoneIds',
    'SRAORetainAudio', 'DISPID_SADefaultFormat', 'ISpRecoContext',
    'SRARoot', 'SAFT11kHz8BitStereo', 'SP_VISEME_10',
    'DISPID_SPRuleConfidence', 'SVP_5', 'DISPID_SGRSTNextState',
    'ISpeechXMLRecoResult', 'ISpObjectToken', 'SpeechVoicePriority',
    'SRAONone', 'SSTTDictation', 'DISPID_SBSWrite', 'SGRSTTRule',
    'DISPID_SOTRemoveStorageFileName', 'SPDKL_CurrentUser',
    'DISPID_SpeechPhraseElements', 'DISPID_SLWType',
    'ISpeechPhraseElements', 'SPSNotOverriden',
    'Speech_StreamPos_RealTime', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SVSInputSentenceLength', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SCSBaseStream', 'SpeechCategoryAudioIn',
    'DISPID_SPRulesItem', 'SAFT8kHz8BitStereo',
    'SpeechRetainedAudioOptions', 'ISpPhrase', 'DISPID_SPPsItem',
    'SREBookmark', 'DISPID_SRCEHypothesis', 'eLEXTYPE_PRIVATE5',
    'SPVPRI_ALERT', 'DISPID_SMSALineId', 'DISPID_SASNonBlockingIO',
    'IInternetSecurityManager', 'SpeechAddRemoveWord',
    'SPEI_END_INPUT_STREAM', 'SAFTADPCM_44kHzMono', 'DISPID_SBSSeek',
    'SAFT16kHz8BitStereo', 'DISPID_SOTCId', 'DISPID_SPCPhoneToId',
    'eWORDTYPE_ADDED', 'SPEI_PHRASE_START', 'SDTPronunciation',
    'SPAR_Low', 'DISPID_SPIEnginePrivateData',
    'DISPID_SPEPronunciation', 'DISPID_SVAudioOutputStream',
    'SpeechTokenKeyAttributes', 'SPPHRASEELEMENT',
    'SAFTCCITT_ALaw_11kHzMono', 'SECFNoSpecialChars', 'SP_VISEME_21',
    'SVF_Stressed', 'DISPID_SVSkip', 'DISPID_SVEStreamEnd',
    'DISPID_SpeechCustomStream', 'DISPID_SDKGetBinaryValue',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPRuleId',
    'DISPID_SPEAudioStreamOffset', '_SPAUDIOSTATE', 'SPBO_AHEAD',
    'SPPS_LMA', 'DISPID_SVGetVoices', 'SAFT8kHz16BitMono',
    'SGRSTTWord', 'DISPID_SPERequiredConfidence', 'SRTAutopause',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SLPs_NewEnum',
    'DISPID_SLPType', 'SpeechRuleState', 'DISPID_SDKSetLongValue',
    'ISpeechVoice', 'SPSHORTCUTPAIRLIST',
    'DISPID_SLRemovePronunciation', 'DISPID_SRCCreateGrammar',
    'SPGS_EXCLUSIVE', 'DISPID_SRCRecognizer', 'DISPID_SRRecognizer',
    'DISPID_SABIMinNotification', 'SpeechVoiceEvents', 'SECFDefault',
    'SPEI_MIN_TTS', 'SPRULE', 'DISPID_SRCEStartStream',
    'SDTAlternates', 'DISPID_SVAlertBoundary', 'SAFTGSM610_44kHzMono',
    'SPEI_PHONEME', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRRAlternates',
    'SPEI_HYPOTHESIS', 'SASStop', 'DISPID_SRGetRecognizers',
    'SLODynamic', 'DISPID_SDKEnumValues', 'SAFT12kHz8BitStereo',
    'SVSFParseSsml', 'SPINTERFERENCE_NONE', 'ISpeechObjectToken',
    'DISPID_SLPPartOfSpeech', 'SGRSTTTextBuffer',
    'eLEXTYPE_PRIVATE20', 'DISPID_SVGetAudioInputs',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRRRecoContext',
    'SPWORDTYPE', 'SAFT16kHz16BitMono', 'SpeechAudioFormatGUIDText',
    'SP_VISEME_12', 'ISpPhraseAlt', 'SPEVENT', 'SPPS_RESERVED1',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpeechGrammarWordType',
    'SRATopLevel', 'SRADefaultToActive', 'ISpeechPhraseReplacement',
    'DISPID_SWFEExtraData', 'SGDSActiveUserDelimited',
    'IEnumSpObjectTokens', 'DISPID_SPCLangId', 'ISpRecoResult',
    'IEnumString', 'SPINTERFERENCE_NOISE', 'DISPID_SRRGetXMLResult',
    'DISPID_SVVolume', 'DISPIDSPTSI', 'SPEI_SOUND_START',
    'DISPID_SLWPronunciations', 'SVP_12', 'SpCustomStream',
    'SPPHRASEPROPERTY', 'DISPID_SpeechMemoryStream',
    'ISpStreamFormat', 'SpeechDiscardType', 'DISPID_SLWsCount',
    'DISPID_SAEventHandle', 'SDA_Two_Trailing_Spaces', 'SP_VISEME_3',
    'SPRST_NUM_STATES',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SRERequestUI',
    'DISPID_SVSLastBookmarkId', 'SVEWordBoundary',
    'DISPID_SOTIsUISupported', 'SPAS_PAUSE', 'SVSFDefault',
    'DISPID_SGRSTPropertyId', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SLPLangId', 'SVSFUnusedFlags', 'SPWORDPRONUNCIATION',
    'DISPID_SPPFirstElement', 'DISPID_SOTSetId',
    'SPEI_PROPERTY_NUM_CHANGE', 'SpeechGrammarTagWildcard',
    'DISPID_SpeechLexiconPronunciation', 'SPGS_ENABLED',
    'SRTEmulated', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'ISpNotifySink',
    'DISPID_SRCVoicePurgeEvent', 'SpeechGrammarTagDictation',
    'SAFT24kHz16BitStereo', 'eLEXTYPE_PRIVATE13', 'DISPID_SPIRule',
    'eLEXTYPE_PRIVATE8', 'SGPronounciation', 'SPSMF_UPS', 'SVP_0',
    'STCInprocServer', 'SPPHRASERULE', 'DISPID_SPEEngineConfidence',
    'DISPID_SPIAudioSizeBytes', 'ISpeechGrammarRuleState',
    'DISPID_SMSAMMHandle', 'DISPIDSPTSI_SelectionLength',
    'SVSFParseAutodetect', 'SPEI_START_INPUT_STREAM',
    'SpeechCategoryVoices', 'DISPID_SOTRemove',
    'DISPID_SDKGetlongValue', 'SPRST_ACTIVE',
    'SWPUnknownWordPronounceable', 'SpTextSelectionInformation',
    'SPRULESTATE', 'DISPID_SRSAudioStatus', 'DISPID_SGRsCount',
    'DISPID_SpeechPhraseElement', 'DISPID_SAStatus', 'SPVPRI_NORMAL',
    'ISpRecognizer2', 'SPXRO_Alternates_SML', 'SAFT32kHz8BitMono',
    'DISPID_SPANumberOfElementsInResult', 'SAFT12kHz16BitMono',
    'ISpDataKey', 'SDTAudio', 'DISPID_SOTDisplayUI',
    'SAFTCCITT_uLaw_11kHzMono', 'SWPUnknownWordUnpronounceable',
    'SPPS_Unknown', 'SAFT11kHz8BitMono', 'SPEI_RESERVED3',
    'DISPID_SpeechPhraseRule', 'SpShortcut', 'SpeechFormatType',
    'DISPID_SABIBufferSize', 'SpeechStreamFileMode', 'DISPID_SVPause',
    'SPPS_SuppressWord', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPEI_RESERVED2', 'SpMMAudioEnum', 'DISPID_SpeechVoiceEvent',
    'DISPID_SpeechRecognizer', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRRPhraseInfo', 'DISPID_SLGetWords', 'DISPID_SLWLangId',
    'DISPID_SLAddPronunciation', 'SPPHRASEREPLACEMENT', 'SPAR_High',
    'ISpeechGrammarRules', 'SP_VISEME_4', 'ISpeechLexiconWords',
    'SAFT16kHz16BitStereo', 'DISPID_SLGetPronunciations',
    'DISPID_SDKSetBinaryValue', 'DISPID_SGRInitialState',
    'STSF_LocalAppData', 'DISPID_SGRsCommitAndSave',
    'DISPID_SRCState', 'ISpEventSource', 'DISPID_SOTsCount',
    'DISPID_SVSpeak', 'ISpeechLexiconWord', 'SRCS_Disabled',
    'DISPID_SVEEnginePrivate', 'SpSharedRecoContext',
    'SpStreamFormatConverter', 'ISpeechPhraseRule',
    'ISpeechGrammarRule', 'SVP_3', 'SVP_19', 'SPEI_RESERVED1',
    'DISPID_SWFEFormatTag', 'SpeechPropertyResourceUsage', 'SVP_13',
    'eLEXTYPE_PRIVATE6', 'eLEXTYPE_RESERVED7',
    'DISPID_SpeechObjectTokenCategory', 'eLEXTYPE_RESERVED6',
    'ISpeechDataKey', 'SECHighConfidence', 'SREPrivate',
    'SpeechTokenIdUserLexicon', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SFSClose', 'DISPID_SRRTTickCount',
    'DISPID_SpeechPhraseBuilder', 'eLEXTYPE_PRIVATE18', 'SP_VISEME_7',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRCPause',
    'SpNullPhoneConverter', 'SPSHT_Unknown',
    'DISPID_SRGCmdSetRuleIdState', 'ISpNotifyTranslator',
    'ISpResourceManager', 'SP_VISEME_14',
    'DISPID_SRCCmdMaxAlternates', 'SP_VISEME_20',
    'SDA_No_Trailing_Space', 'ISpeechRecoContext', 'DISPID_SGRSTRule',
    'SPEI_REQUEST_UI', 'ISpeechPhraseRules',
    'DISPID_SPPEngineConfidence',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechRegistryLocalMachineRoot', 'SVSFNLPSpeakPunc',
    'SRSInactive', 'SPSSuppressWord',
    'SpeechGrammarTagUnlimitedDictation', 'ISpObjectWithToken',
    'DISPID_SPRsItem', 'Speech_Max_Word_Length',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SRRGetXMLErrorInfo',
    'SpeechVoiceSpeakFlags', 'DISPID_SRRSpeakAudio',
    'DISPID_SpeechRecoResult2', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SABIEventBias',
    'DISPID_SRCERequestUI', 'SSTTWildcard', 'SPEI_MIN_SR',
    'DISPID_SGRSTPropertyName', 'SpeechInterference',
    'SPEI_TTS_AUDIO_LEVEL', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SVSInputWordLength', 'DISPID_SPRNumberOfElements',
    'DISPID_SRGDictationUnload', 'SPFILEMODE', 'eLEXTYPE_RESERVED9',
    'SPPS_Verb', 'SSFMOpenForRead', 'SVPOver', 'SpeechVisemeType',
    'SpeechGrammarState', 'SPVPRIORITY', 'SREStreamEnd',
    'SPPARTOFSPEECH', 'SGRSTTWildcard', 'DISPID_SRCESoundStart',
    'SGDSActive', 'DISPID_SPIGetDisplayAttributes',
    'SAFT48kHz16BitMono', 'SPWF_SRENGINE', 'DISPID_SPPConfidence',
    'DISPID_SOTDataKey', 'DISPID_SRRTimes', 'ISpProperties',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVP_2',
    'ISpeechPhraseInfo', 'SPRS_INACTIVE', 'SBONone',
    'DISPID_SPISaveToMemory', 'ISpeechRecoResult2',
    'SAFT12kHz8BitMono', 'DISPID_SRDisplayUI', 'ISpRecoGrammar2',
    'SPBINARYGRAMMAR', 'ISpeechVoiceStatus', 'SpeechAudioVolume',
    'DISPID_SpeechAudioFormat', 'SPGRAMMARWORDTYPE',
    'SAFTADPCM_11kHzStereo', 'DISPID_SRCERecognition', 'LONG_PTR',
    'SpeechRecoProfileProperties', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SAFSetWaveFormatEx',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SRCRequestedUIType', 'DISPID_SRGCommit', 'ISpAudio',
    'DISPID_SRGIsPronounceable', 'SPCT_SUB_COMMAND',
    'SAFTGSM610_8kHzMono', 'SPXMLRESULTOPTIONS',
    'SPDKL_CurrentConfig', 'SpeechTokenShellFolder', 'DISPID_SVVoice',
    'DISPID_SVEWord', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SLPsCount',
    'SWPKnownWordPronounceable', 'DISPID_SPEs_NewEnum',
    'ISpeechAudioStatus', 'SPEI_VISEME',
    'DISPID_SASCurrentDevicePosition', 'SECNormalConfidence',
    'SpeechGrammarRuleStateTransitionType',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SPIGrammarId',
    'tagSPTEXTSELECTIONINFO', 'SINoise', 'DISPID_SGRSTsItem',
    'SPEI_VOICE_CHANGE', 'SRSEDone', 'SPLEXICONTYPE',
    'DISPID_SRGetPropertyString', 'SPBO_NONE', 'SP_VISEME_18',
    'SpeechCategoryPhoneConverters', 'SpeechDataKeyLocation',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPEActualConfidence', 'SpPhoneticAlphabetConverter',
    'eLEXTYPE_PRIVATE15', 'SVPNormal', 'DISPID_SOTsItem',
    'SAFT22kHz8BitStereo', 'SpeechAudioState',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRIsUISupported',
    'SVEPrivate', 'DISPID_SRRSaveToMemory', 'SAFTText',
    'DISPID_SFSOpen', 'ISpeechMemoryStream', 'SpeechLoadOption',
    'ISpeechPhraseReplacements', 'SRSInactiveWithPurge',
    'SPWT_DISPLAY', 'DISPID_SPRFirstElement',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SLPSymbolic', 'SPAS_STOP',
    'SVF_None', 'DISPID_SASetState', 'SpeechUserTraining',
    'SPEI_SR_AUDIO_LEVEL', 'SREFalseRecognition', 'STCRemoteServer',
    'DISPID_SPPs_NewEnum', 'SAFTGSM610_11kHzMono', 'SPSModifier',
    'DISPID_SLGenerationId', 'DISPID_SRGRules', 'eLEXTYPE_APP',
    'ISpeechLexicon', 'SGSExclusive', 'DISPID_SGRSTText',
    'DISPIDSPTSI_SelectionOffset', 'SAFT48kHz16BitStereo',
    'SVSFParseMask', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRCEAdaptation', 'SpPhraseInfoBuilder',
    'DISPID_SpeechBaseStream', 'DISPID_SPEDisplayText',
    'DISPID_SpeechRecoResult', 'SRAInterpreter', 'DISPID_SGRAddState',
    'tagSTATSTG', 'SP_VISEME_19', 'SGSDisabled',
    'DISPID_SRSSupportedLanguages', 'SPLO_STATIC',
    'SpeechCategoryAppLexicons', 'tagSPPROPERTYINFO', 'SP_VISEME_11',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SVStatus',
    'SGRSTTEpsilon', 'DISPID_SRRAudioFormat', 'ISpeechFileStream',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SMSADeviceId',
    'SpeechBookmarkOptions', 'SpeechVoiceCategoryTTSRate',
    'SpInProcRecoContext', 'SPAUDIOBUFFERINFO',
    'SAFTCCITT_ALaw_8kHzMono', 'SVSFPersistXML', 'SPVPRI_OVER',
    'SPEI_SR_PRIVATE', 'DISPID_SRAudioInputStream',
    'DISPID_SDKEnumKeys', 'SPEVENTSOURCEINFO', 'SAFT44kHz8BitMono',
    'SREInterference', 'ISpeechResourceLoader', 'SITooSlow',
    'SSFMOpenReadWrite', 'SpObjectTokenCategory',
    'DISPID_SOTs_NewEnum', 'SPSHT_EMAIL', 'SPWT_LEXICAL',
    'SVEEndInputStream', 'SVEAudioLevel', 'SPEI_MAX_TTS',
    'SAFT24kHz8BitStereo', 'UINT_PTR', 'SPPS_RESERVED2',
    'DISPID_SGRsItem', 'SPEI_ADAPTATION',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SGRAttributes',
    'DISPID_SGRClear', 'SAFT44kHz16BitStereo',
    'DISPID_SpeechGrammarRules', 'SPCONTEXTSTATE',
    'SAFTADPCM_22kHzStereo', 'ISpeechLexiconPronunciation',
    'eLEXTYPE_PRIVATE11', 'SpeechPropertyLowConfidenceThreshold',
    'SpeechAllElements', 'SPEI_SOUND_END',
    'DISPID_SpeechPhraseReplacements', 'SpeechPropertyAdaptationOn',
    'SAFTDefault', 'DISPID_SpeechObjectTokens',
    'DISPID_SVESentenceBoundary', 'ISpStreamFormatConverter',
    'DISPID_SPAsItem', 'DISPID_SPPNumberOfElements',
    'DISPID_SVGetProfiles', 'eLEXTYPE_RESERVED8', 'SREHypothesis',
    'eLEXTYPE_PRIVATE7', 'ISpeechRecoGrammar', 'SECFIgnoreKanaType',
    'DISPID_SGRsCommit', 'DISPID_SOTCreateInstance', 'STSF_AppData',
    'SpFileStream', 'DISPID_SVSInputWordPosition', 'DISPID_SRGState',
    'DISPIDSPRG', 'SP_VISEME_16', 'SpInprocRecognizer', 'SVP_9',
    'DISPID_SVSInputSentencePosition', 'SAFTNoAssignedFormat',
    'SAFT8kHz8BitMono', 'DISPID_SGRSTPropertyValue',
    'DISPID_SPRDisplayAttributes', 'DISPID_SPAStartElementInResult',
    'DISPID_SPIReplacements', 'DISPID_SPEDisplayAttributes',
    'DISPID_SPRuleNumberOfElements', 'SAFT22kHz16BitStereo',
    'ISpSerializeState', 'SFTInput', 'DISPID_SVSpeakStream',
    'SpeechEngineProperties', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SpeechRecoContext', 'DISPID_SRCEPhraseStart', 'SVP_16',
    'DISPID_SRGetFormat', 'SAFT22kHz8BitMono',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SpeechLexicon',
    'SpeechVisemeFeature', 'SPLO_DYNAMIC', 'SSSPTRelativeToStart',
    'SVEStartInputStream', 'DISPID_SAFType', 'SAFTADPCM_8kHzMono',
    'SPPS_Noncontent', 'eLEXTYPE_PRIVATE12', 'SREPropertyNumChange',
    'DISPID_SGRName', 'SREStreamStart', 'SPSERIALIZEDPHRASE',
    'SPSMF_SAPI_PROPERTIES', 'SREAdaptation', 'eLEXTYPE_PRIVATE3',
    'SPSTREAMFORMATTYPE', 'DISPID_SRSCurrentStreamPosition',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SPELexicalForm',
    'eLEXTYPE_PRIVATE4', 'ISpVoice', 'SPCT_DICTATION',
    'DISPID_SRGDictationLoad',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpEventSink',
    'SPAR_Unknown', 'SPAS_RUN', 'DISPID_SpeechPhoneConverter',
    'DISPID_SRCEBookmark', 'STCInprocHandler', 'DISPID_SGRSRule',
    'SP_VISEME_0', 'DISPID_SDKGetStringValue', 'SPFM_CREATE',
    'SP_VISEME_2', 'DISPID_SPRs_NewEnum',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SPARecoResult',
    'DISPID_SRRTStreamTime', 'SPVOICESTATUS', 'SLTApp', 'SPAO_NONE',
    'DISPID_SpeechPhraseAlternate', 'SSFMCreate', 'SPXRO_SML',
    'DISPID_SPPId', 'Speech_Max_Pron_Length', 'SINoSignal',
    'DISPID_SPIAudioSizeTime', 'SPPS_NotOverriden', 'SP_VISEME_13',
    'SPEI_MAX_SR', 'SAFT44kHz8BitStereo', 'SVSFIsNotXML',
    'DISPID_SRCEEnginePrivate', 'SRAImport', 'SPSInterjection',
    'DISPID_SPRulesCount', 'SDKLDefaultLocation', 'DISPID_SVEPhoneme',
    'SpeechAudioProperties', 'ISpStream', 'DISPID_SPRText',
    'DISPID_SVEViseme', 'ISpXMLRecoResult',
    'DISPID_SRCERecognizerStateChange', 'SPRECOCONTEXTSTATUS',
    'DISPID_SDKDeleteValue', 'DISPID_SPPParent',
    'SSSPTRelativeToCurrentPosition',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRGRecoContext',
    'SPEI_END_SR_STREAM', 'DISPID_SPRuleName', 'SAFT12kHz16BitStereo',
    'DISPID_SPAs_NewEnum', 'ISpeechPhoneConverter', 'DISPID_SOTId',
    'SPADAPTATIONRELEVANCE', 'ISpPhoneticAlphabetConverter', 'SVP_4',
    'DISPID_SOTGetAttribute', '__MIDL_IWinTypes_0009',
    'DISPID_SPAPhraseInfo', 'ISpeechPhraseProperty', 'SINone',
    'DISPID_SLPsItem', 'DISPID_SRSClsidEngine',
    'DISPID_SVSCurrentStreamNumber', 'SpMMAudioIn',
    'SpeechAudioFormatType', 'DISPID_SRAudioInput', 'SP_VISEME_8',
    'ISpMMSysAudio', 'DISPID_SPPChildren', 'DISPID_SVSLastResult',
    'SPEI_UNDEFINED', 'SPFM_OPEN_READWRITE', 'eLEXTYPE_USER_SHORTCUT',
    'SRTReSent', 'SAFT16kHz8BitMono', 'DISPID_SpeechObjectToken',
    'SGSEnabled', 'DISPID_SpeechRecognizerStatus', 'DISPID_SPPValue',
    'DISPID_SPRuleChildren', 'DISPID_SVSyncronousSpeakTimeout',
    'SpObjectToken', 'SVSFParseSapi', 'SVEBookmark',
    'SpeechRecoContextState', 'DISPID_SRCSetAdaptationData',
    'ISpeechGrammarRuleStateTransition',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SITooLoud',
    'DISPID_SPILanguageId', 'SRERecoOtherContext',
    'SSSPTRelativeToEnd', 'STSF_FlagCreate', 'DISPID_SpeechVoice',
    'SPWF_INPUT', 'ISpRecoContext2', 'eLEXTYPE_PRIVATE2',
    'DISPID_SpeechAudioBufferInfo', 'SPAS_CLOSED', 'STCAll',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SRCEFalseRecognition',
    'DISPID_SDKDeleteKey', 'SVSFIsFilename', 'SAFTADPCM_8kHzStereo',
    'SVSFlagsAsync', 'SAFT44kHz16BitMono', 'ISpLexicon', 'SVP_15',
    'SDKLLocalMachine', 'SPSHORTCUTPAIR',
    'SDA_Consume_Leading_Spaces', 'DISPID_SVSRunningState',
    'SPWAVEFORMATTYPE', 'SAFT11kHz16BitStereo',
    'DISPID_SDKSetStringValue', 'SRSActive', 'SVF_Emphasis',
    'SRTStandard', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechRecognizerState', 'SVEAllEvents', 'SRTSMLTimeout',
    'DISPID_SASState', 'ISpeechCustomStream',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpStream', 'SLTUser',
    '_RemotableHandle', 'DISPID_SRRDiscardResultInfo', 'SVP_17',
    'SpeechPartOfSpeech', 'SPPROPERTYINFO', 'SREPhraseStart',
    'DISPID_SRGReset', 'SPSEMANTICERRORINFO',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SGRSAddWordTransition',
    'DISPID_SVSVisemeId', 'SPAUDIOOPTIONS', 'DISPID_SRIsShared',
    'SpMMAudioOut', 'SGDSActiveWithAutoPause', 'SRERecognition',
    'SPRST_INACTIVE_WITH_PURGE', 'SVSFNLPMask',
    'DISPID_SRCEEndStream', 'SAFTCCITT_uLaw_8kHzMono',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SBSFormat',
    'SpeechTokenKeyFiles', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SVSpeakCompleteEvent', 'SECFIgnoreWidth',
    'DISPID_SRRTOffsetFromStart', 'SpResourceManager',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SGRSAddSpecialTransition',
    'SpCompressedLexicon', 'SECFIgnoreCase', 'ISpeechRecoResultTimes',
    'SPEI_START_SR_STREAM', 'DISPID_SPIStartTime',
    'DISPID_SpeechAudio', 'SAFTCCITT_ALaw_22kHzMono',
    'SDA_One_Trailing_Space', 'DISPID_SVSLastBookmark',
    'DISPID_SGRs_NewEnum', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SPAsCount', 'ISpeechLexiconPronunciations',
    'SPINTERFERENCE_TOOQUIET', 'SREStateChange', 'SPEI_WORD_BOUNDARY',
    'ISpeechAudioFormat', 'SPEI_SENTENCE_BOUNDARY',
    'ISpeechTextSelectionInformation', 'SPSNoun', 'SVPAlert',
    'SGDSInactive', 'SpeechWordPronounceable',
    'DISPID_SREmulateRecognition', 'SPPS_Interjection', 'SP_VISEME_1',
    'DISPID_SpeechDataKey', 'eLEXTYPE_VENDORLEXICON',
    'STSF_CommonAppData', 'ISpeechRecognizer', 'DISPID_SWFEChannels',
    'SVP_10', 'SRSActiveAlways', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SVSPhonemeId', 'DISPID_SOTMatchesAttributes',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SGRSTsCount', 'SVP_21',
    'DISPID_SOTGetStorageFileName', 'eLEXTYPE_USER',
    'DISPID_SRGetPropertyNumber', 'DISPID_SVEStreamStart',
    'DISPID_SGRSTs_NewEnum', 'SPAR_Medium',
    'DISPID_SPIAudioStreamPosition', 'SRESoundEnd',
    'Speech_Default_Weight', 'SAFTGSM610_22kHzMono', 'SPRST_INACTIVE',
    'SDTReplacement', 'SPAUDIOSTATUS',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPWORD',
    'SAFT48kHz8BitMono', 'SPPS_Function', 'ISpRecognizer3',
    'DISPID_SGRsFindRule', 'SPAO_RETAIN_AUDIO', 'ISpGrammarBuilder',
    'SpeechDictationTopicSpelling', 'SPSLMA',
    'DISPID_SRCreateRecoContext', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRProfile', 'SP_VISEME_5', 'SAFTExtendedAudioFormat',
    'DISPID_SRCESoundEnd', 'SPEI_TTS_BOOKMARK', 'DISPID_SPPName',
    'DISPID_SpeechAudioStatus', 'SpeechCategoryAudioOut',
    'SPBO_PAUSE', 'DISPID_SRCBookmark', 'DISPID_SGRSTransitions',
    'DISPID_SRGDictationSetState', 'SpeechLexiconType',
    'ISpeechPhraseAlternate', 'SpeechVoiceSkipTypeSentence',
    'SPSHT_OTHER', 'SPAUDIOSTATE', 'SDTLexicalForm',
    'DISPID_SpeechVoiceStatus', 'SRADynamic', 'SVEVoiceChange',
    'SVP_20', 'SpeechEngineConfidence', 'DISPID_SBSRead',
    'SpeechStreamSeekPositionType', 'DISPID_SLGetGenerationChange',
    'SpMemoryStream', 'DISPID_SPCIdToPhone', 'SPRECORESULTTIMES',
    'DISPID_SPRuleParent', 'eLEXTYPE_PRIVATE19', 'DISPID_SGRSTWeight',
    'ISpPhoneConverter'
]

_check_version('1.2.0', 1698398516.422630)
